...
{
    public class DetectionImgDog : ISample
    {
        public void Run()
        {
            var haarCascade = new CascadeClassifier(FilePath.Text.HaarCascadeDog2);
        ...
        {
            Mat result;
            using (var src = new Mat(FilePath.Image.Dog2, ImreadModes.Color))
            {
